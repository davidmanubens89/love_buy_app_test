...
const washingMachines = [
  { id: 1, name: 'EcoWash Pro', brand: 'GreenTech', price: 599, rating: 4.5, features: ['Energy efficient', 'Large capacity', 'Smart controls'] },
  { id: 2, name: 'SpeedMaster 3000', brand: 'QuickClean', price: 499, rating: 4.2, features: ['Quick wash cycles', 'Compact design', 'Multiple wash programs'] },
  { id: 3, name: 'SilentWash Elite', brand: 'WhisperAppliances', price: 699, rating: 4.7, features: ['Ultra-quiet operation', 'Steam cleaning', 'Anti-vibration technology'] },
];
            ...
            {washingMachines.map(machine => (
              <Card key={machine.id}>
                <CardContent className="p-4">
                  <Image
                    src={`https://source.unsplash.com/random/300x200?washing+machine`}
                    alt={machine.name}
                    width={300}
                    height={200}
