    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { title: 'Top 10 Washing Machine Features', description: 'Discover the must-have features for your next washing machine...' },
            { title: 'Luggage Trends for 2024', description: 'Stay ahead of the curve with these upcoming luggage trends...' },
            { title: 'Eco-Friendly Laundry Tips', description: 'Learn how to reduce your environmental impact while doing laundry...' },
          ].map((article, index) => (
            <Card key={index}>
              <CardContent className="p-6">
                <Image
                  src={`https://source.unsplash.com/random/400x300?${article.title.toLowerCase().replace(/ /g, '+')}`}
                  alt={article.title}
                  width={400}
                  height={300}
